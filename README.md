...
Делал это задание в первую очередь, т.к. оно мне показалось самым сложным, по итогу после выполнения остальных 2 задач и получения новых навыков сделал бы ее иначе))
