...
$arResult['DIFFERENT'] = 'Y'; //Принудительно выбираем режим отображения только характеристик с различиями
...
<div class="catalog-compare mb-4 bx-<? echo $templateData['TEMPLATE_CLASS']; ?>" id="bx_catalog_compare_block"><?
	...
	?>
	<? if (false) : //скрываем кнопки выбора режима отображения характеристик с различием?>
